...
models.cv.main("models.gi_mn", "cfgs/models/yeast_gi_mn.json", 
    "../results/task_yeast_gi_hybrid_fs/mn_no_lid", 
    num_processes=10,
    remove_specs=["topology"])

models.cv.main("models.gi_mn", "cfgs/models/yeast_gi_mn.json", 
    "../results/task_yeast_gi_hybrid_fs/mn_no_spl", 
    num_processes=10,
    remove_specs=["spl"])

models.cv.main("models.tgi_mn", "cfgs/models/yeast_tgi_mn.json", 
    "../results/task_yeast_tgi_fs/mn_no_lid", 
    remove_specs=["topology"],
    num_processes=20)

models.cv.main("models.tgi_mn", "cfgs/models/yeast_tgi_mn.json", 
    "../results/task_yeast_tgi_fs/mn_no_spl", 
    remove_specs=["spl"],
    num_processes=20)
