...
if not os.path.exists('../figures/pombe_smf'):
    os.makedirs('../figures/pombe_smf')

analysis.fig_cs_vs_std.main("../generated-data/task_pombe_smf", "../figures/pombe_smf/cs_vs_std.png", show=False)
analysis.fig_feature_violin.main("../generated-data/task_pombe_smf", "../generated-data/features/ppc_pombe_topology.npz", 
    0, "LID Score", "../figures/pombe_smf/lid_violin.png")
analysis.fig_feature_violin.main("../generated-data/task_pombe_smf", "../generated-data/features/ppc_pombe_redundancy.npz", 
    0, "Percent Identity Score", "../figures/pombe_smf/pident_violin.png")
