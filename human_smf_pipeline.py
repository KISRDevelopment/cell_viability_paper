...
human_smf_task = "../generated-data/task_human_smf"
...
ppc_creation.ppc.main("human", gpath)
...
# # 4. Create Task
tasks.human_smf.main(gpath)

# 5. Create Targets & CV Splits
utils.bin_simple.main(human_smf_task)
utils.cv_simple.main(human_smf_task, 10, 5, 0.2)

# 6. Execute CV on refined, or, null models
models.cv.main("models.null_model", "cfgs/models/human_smf_refined_model.json", "../results/task_human_smf/null")
models.cv.main("models.smf_nn", "cfgs/models/human_smf_refined_model_scrambled.json", "../results/task_human_smf/null_scarmbled")
